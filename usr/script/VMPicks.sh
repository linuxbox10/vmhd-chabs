...
# SCRIPT: VMPicks.sh
#
# Pick random entries from image lists generated by ChabsScrape.sh
...
#          $sources_maxage. Doing so will have this script call ChabsScrape.sh
...
#          download the lists from a server. In this case script ChabsScrape.sh
...
# UNDO??   TOPPICKS IMAGE PICONS ARE HARDCODED IN THE CHABS SKINS... THIS MEANS:
...
piconbase="/usr/share/enigma2/VM-HD/TopPicks/picons-base/"
piconpath="/usr/share/enigma2/VM-HD/TopPicks/picons/"
screenpath="/usr/share/enigma2/VM-HD/TopPicks"
scraper="/usr/script/ChabsScrape.sh"
...
for image_no in 1 2 3 5; do
  # Set the toppicks image size and define allowed categories
  case ${image_no} in
    1) resize="w=167&h=125&mode=crop"; min_category="1"; max_category="1" ;;
    2) resize="w=167&h=125&mode=crop";  min_category="3"; max_category="3" ;;
    3) resize="w=167&h=125&mode=crop"; min_category="5"; max_category="5" ;;
    5) resize="w=167&h=125&mode=crop"; min_category="6"; max_category="6" ;;
    esac
